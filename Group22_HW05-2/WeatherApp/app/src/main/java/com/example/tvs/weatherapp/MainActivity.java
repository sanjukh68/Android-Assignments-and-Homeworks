...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("FavouriteCities", Context.MODE_PRIVATE);
        ...
        favouritesList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent getWeatherDetails = new Intent(MainActivity.this, WeatherForecast.class);
                String apiWithParams = WEATHER_API_ENDPOINT.
                        replace("%stateName%", favouriteCities.get(position).state).replace("%cityName%", favouriteCities.get(position).city);
                getWeatherDetails.putExtra(ENP_POINT_WITH_PARAMS, apiWithParams);
                getWeatherDetails.putExtra(CITY_KEY, favouriteCities.get(position).city);
                getWeatherDetails.putExtra(STATE_KEY, favouriteCities.get(position).state);
