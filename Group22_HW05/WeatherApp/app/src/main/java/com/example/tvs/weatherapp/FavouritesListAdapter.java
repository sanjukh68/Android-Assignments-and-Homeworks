...
public class FavouritesListAdapter extends ArrayAdapter<CityWeather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.favoutiteTemp)).setText(cityWeather.hourly_forecast.get(0).temp.english + " F");
        ((TextView) convertView.findViewById(R.id.textVilastUpdated))
                .setText("Updated on: " + cityWeather.hourly_forecast.get(0).FCTTIME.mon + "/"
                                        + cityWeather.hourly_forecast.get(0).FCTTIME.mday + "/"
                                        + cityWeather.hourly_forecast.get(0).FCTTIME.year);
        return convertView;
    }
}