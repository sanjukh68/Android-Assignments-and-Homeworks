...
public class FavouritesListAdapter extends ArrayAdapter<WeatherResponse> {

    Context context;
    int resource;
    List<WeatherResponse> objects;

    public FavouritesListAdapter(Context context, int resource, List<WeatherResponse> objects) {
