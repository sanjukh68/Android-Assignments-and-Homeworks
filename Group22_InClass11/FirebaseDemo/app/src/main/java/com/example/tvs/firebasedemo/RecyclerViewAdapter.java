...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, int resource, List<Conversation> objects, ClickHandler clickHandler) {
    ...
    public RecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder vh = new RecyclerViewAdapter.ViewHolder(view);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        if(!objects.get(position).userId.equals(HomeActivity.firebaseUser.getUid()))
            holder.deleteButton.setVisibility(View.GONE);

        CommentLVAdapter commentLVAdapter = new CommentLVAdapter(this.context, R.layout.comments_lv, objects.get(position).comments);
